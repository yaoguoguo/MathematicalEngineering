...
# This program compute the legendre symbol mod p for each numbers between 1 and 100
...
while(n > 0):
    ...
    n = n // 10
numdig = count
# print(numdig)     # numdig is the number of digits of b
...
print qua_res
print len(qua_res) # this is the number of values of a s.t. (a/p)=1
